...
export var issOnlineUrl = "http://127.0.0.1:24010/ZKIDROnline";
export var browserFlag = getBrowserType();
/*
$().ready(function(){
...
export  var setting = {
			Cert : {
				callBack : function(result){
					...
					// console.log(JSON.stringify(result))
					var massageList=result
					console.log(massageList)
					window.massageList=massageList
...
// import {createISSonlineDevic} from './baseISSOnline'
        createISSonlineDevic(setting);
//});
//});
...
export function closeMessage(timeout)
{
...
{ 
	...
	export function createISSonlineDevic(setting)
				{ 
